...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            $query_select = "SELECT date_time,contact_id,Description,Type_ID,Status_ID,Solution_ID FROM incident";
            ...
            mysqli_stmt_bind_result($statement, $datetime, $client_id, $description, $type_id, $status_id, $solution_id);
...
//Fetch de informatie van de statement
                ...
                while ($row = mysqli_stmt_fetch($statement)) {
                    ...
                    $time = substr($datetime, strpos($datetime, " "));
                    echo "<tr>";
                    echo "<td>" . $time . "</td>";

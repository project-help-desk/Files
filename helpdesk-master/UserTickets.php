    ...
    <body>
        <?php
               ...
               // }
                ...
                // $incidentId = 7;
                $SQLstring ="SELECT incident_id,Satuts_id,Solution_id,Contact_id,Operator_id,Date_time,Description,type_id FROM incident,incident_status WHERE incident.Status_id = 
